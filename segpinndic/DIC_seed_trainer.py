...
from segpinndic.DIC_importlib import time, jax, jnp, np, jit, vmap, value_and_grad, partial, optax
from segpinndic.utils.logger import logger
from segpinndic.DIC_trainers import (
    PINN_model_inner,
    FBPINN_model,
    get_inputs,
    tree_map_dicts,
)
from segpinndic.utils.jax_util import partition, combine
